...
<table width="200" border="0" cellspacing="1" cellpadding="0">
    ...
    <tr id="divLogin" runat="server">
      ...
      <td height="20" bgcolor="#1A9CE3"><asp:HyperLink CssClass="izq" ID="lnkCRM" NavigateUrl="Login.aspx" runat="server">CRM Login</asp:HyperLink></td>
      <td height="20">&nbsp;</td>
    </tr>
    ...
    <tr id="divlnkHome">
      <td height="20">&nbsp;</td>
      <td bgcolor="#d2d2c6">&nbsp;</td>
      <td height="20" bgcolor="#1A9CE3"><ASP:HyperLink CssClass="izq" id="lnkHome"
    ...
    <tr id="divlblVentas" >
      ...
      <td height="20" bgcolor="#1A9CE3" class="titleBlanco" style="HEIGHT: 21px">
    ...
    <tr id="divlnkAddVenta" >
      ...
      <td height="20" bgcolor="#1A9CE3">&nbsp;&nbsp;&nbsp;&nbsp;<ASP:HyperLink id="lnkAddVenta" runat="server" cssclass="izq2" navigateurl="AddVenta.aspx">Nueva Venta</ASP:HyperLink></td>
      <td height="20">&nbsp;</td>
    </tr>
    <tr id="divlnkListVentas" >
      <td height="20">&nbsp;</td>
      <td width="4" bgcolor="37703e">&nbsp;</td>
      <td height="20" bgcolor="#1A9CE3">&nbsp;&nbsp;&nbsp;&nbsp;<ASP:HyperLink
    ...
    <tr id="divlblProductos" >
      ...
      <td height="20" bgcolor="#1A9CE3" class="titleBlanco">
    ...
    <tr id="divlnkChangePassword" >
      <td height="20">&nbsp;</td>
      <td width="4" bgcolor="#d2d2c6">&nbsp;</td>
      <td height="20" bgcolor="#1A9CE3" classname="izq"><ASP:HyperLink id="lnkChangePassword" class="izq"
    ...
    <tr id="divlnkLogout" >
      ...
      <td height="20" bgcolor="#1A9CE3" style="HEIGHT: 20px">
        <p>
