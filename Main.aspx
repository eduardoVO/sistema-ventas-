...
BODY {
	BACKGROUND-IMAGE: url(Images/fondo.jpg); BACKGROUND-COLOR: #171817
}
</style></head>
...
<table width="1000" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#ffffff">
    ...
    <tr>
      <td width="200" rowspan="2" align="left" valign="top" bgcolor="#9C9C9C"><uc1:UCNavigation id="UserControl2" runat="server"></uc1:UCNavigation></td>
	  <td height="20" colspan="3" valign="top"  >&nbsp; <h2> Bienvenidos al Sistema de Ventas </h2></td>
    </tr>
    <tr>
